...
from paddle_tabnet.utils import PredictDataset, filter_weights
from paddle_tabnet.abstract_model import TabModel
from paddle_tabnet.multiclass_utils import infer_output_dim, check_output_dim
...
class TabNetClassifier(TabModel):
    ...
    def compute_loss(self, y_pred, y_true):
        y_true = paddle.cast(y_true, 'int64')
    ...
    def predict_proba(self, X):
        ...
        for batch_nb, data in enumerate(dataloader):
            ...
            predictions = paddle.nn.Softmax(axis=1)(output).detach().numpy()
